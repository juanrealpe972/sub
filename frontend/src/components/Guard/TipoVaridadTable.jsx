...
import { Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, Input, Button, Chip, Pagination, Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, } from "@nextui-org/react";
...
export default function TipoVariedadTable({ registrar, data, results, actualizar, desactivar, activar }) {
    ...
    const bottomContent = useMemo(() => {
        return (
            <div className="py-5 px-2 flex justify-between items-center m-4">
                <Pagination
                    isCompact
                    showControls
                    showShadow
    ...
    return (
        <>
            ...
            >
                ...
                <TableBody emptyContent={"Varidades no encontradas"} items={sortedItems}>
                    {(item) => (
