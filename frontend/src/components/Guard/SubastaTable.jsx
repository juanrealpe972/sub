      ...
      {subastaForuser && subastaForuser.length > 0 ? (
        <div className="grid grid-cols-3 justify-center items-center gap-4 p-3">
          {subastaForuser.map((subasta) => (
            <Card key={subasta.pk_id_sub} className="max-w-[410px] h-[540px]">
                  ...
                  <div
                    ...
                    ${
                      subasta.estado_sub === "proceso"
                        ? "bg-orange-500 border-orange-600 text-orange-50"
                        : ""
                    }
                    ${
                    ...
                    ${
                      subasta.estado_sub === "cerrada"
                        ? "bg-red-400 border-red-600 text-red-50"
                        : ""
                    } 
                  `}
                  >
                  ...
                  <div className="grid gap-x-2 py-2 px-2 text-sm max-h-[300px] overflow-y-auto">
                    <div className="flex flex-col">
                      ...
                      <div className="flex gap-x-2">
                        ...
                        <p>
                          $
                          {Number(subasta.precio_inicial_sub).toLocaleString(
                            "es-ES"
                          )}
                        </p>
                      </div>
                      {subasta.estado_sub === "cerrada" && (
                        <>
                          <div className="flex gap-x-2">
                            ...
                            <p>
                              $
                              {Number(subasta.precio_final_sub).toLocaleString(
                                "es-ES"
                              )}
                            </p>
                          </div>
